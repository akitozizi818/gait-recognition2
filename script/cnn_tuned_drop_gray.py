...
# コンフィグレーションの設定と保存
config = {
    "dataset_root": "./sorted_dataset/dataset",
    "test_data_dir": "./sorted_dataset/test_dataset",
    # "img_size": (84, 84),
    "img_size": (48, 48),
    "batch_size": 8,
    "num_classes": 10,
    "validation_split": 0.2,
    "iterations": 30,#もともと30
    "epochs": 20,#もともと20
...
for i in range(config["iterations"]):
    ...
    model = models.Sequential([
        ...
        layers.Conv2D(256, (5, 5), activation="swish", input_shape=(48, 48, 1)),
